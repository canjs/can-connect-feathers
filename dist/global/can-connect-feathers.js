...
/*can-connect-feathers@1.1.2#utils*/
        ...
        return $traceurRuntime.createClass(Feathers, {
            connectSocket: function () {
                ...
                this.ioConnected = new Promise(function (resolve, reject) {
                    $__17.io = io($__17.url, $__17.socketOptions);
                    $__17.io.once('connect', resolve);
                    $__17.io.once('error', reject);
                });
            },
            ...
            authenticate: function (params) {
                ...
                return authPromise.then(function (data) {
                    return $__17.persistToken(data);
                }).then(function (data) {
                    return $__17.makeSSRCookie(data);
                });
            },
                ...
                return new Promise(function (resolve, reject) {
                    var sendSocketAuthRequest = function (data) {
                        ...
                        this.io.once('authenticated', function (res) {
                            if (!$__18._reconnectsHandled) {
                                $__18.handleSocketReconnects(data);
                                $__18._reconnectsHandled = true;
                            }
                            resolve(res);
                        });
                    ...
                    if ($__17.io.connected) {
                        sendSocketAuthRequest.call($__17, data);
                    } else {
                        $__17.io.once('connect', function () {
                            return sendSocketAuthRequest.call($__17, data);
                        });
                    }
                });
            },
            handleSocketReconnects: function (data) {
                ...
                this.io.on('reconnect', function () {
                    $__17.authenticateSocket(data).then(function (data) {
                        return $__17.persistToken(data);
                    }).then(function (data) {
                        return $__17.makeSSRCookie(data);
                    });
            ...
            logout: function (data) {
                ...
                return new Promise(function (resolve) {
                    $__17.storage.removeItem($__17.tokenLocation);
                    cookieStorage.removeItem($__17.tokenLocation);
                    if ($__17.allowSocketIO) {
                        $__17.io.disconnect();
                        $__17.connectSocket();
                    }
                    resolve(data);

...
/*can-connect-feathers@1.1.4#utils*/
...
define('can-connect-feathers', [
    ...
    'can-connect-feathers/utils',
    'feathers-errors'
], function ($__0, $__2, $__4, $__6, $__8, $__10, $__12, $__14) {
    'use strict';
        ...
        return $traceurRuntime.createClass(Feathers, {
            connectSocket: function () {
                ...
                this.ioConnected = new Promise(function (resolve, reject) {
                    $__19.io = io($__19.url, $__19.socketOptions);
                    $__19.io.once('connect', resolve);
                    $__19.io.once('error', reject);
                });
            },
            ...
            authenticate: function (params) {
                ...
                return authPromise.then(function (data) {
                    return $__19.persistToken(data);
                }).then(function (data) {
                    return $__19.makeSSRCookie(data);
                });
            },
                ...
                return new Promise(function (resolve, reject) {
                    var sendSocketAuthRequest = function (data) {
                        ...
                        this.io.once('authenticated', function (res) {
                            if (!$__20._reconnectsHandled) {
                                $__20.handleSocketReconnects(data);
                                $__20._reconnectsHandled = true;
                            }
                            resolve(res);
                        });
                    ...
                    if ($__19.io.connected) {
                        sendSocketAuthRequest.call($__19, data);
                    } else {
                        $__19.io.once('connect', function () {
                            return sendSocketAuthRequest.call($__19, data);
                        });
                    }
                });
            },
            handleSocketReconnects: function (data) {
                ...
                this.io.on('reconnect', function () {
                    $__19.authenticateSocket(data).then(function (data) {
                        return $__19.persistToken(data);
                    }).then(function (data) {
                        return $__19.makeSSRCookie(data);
                    });
            ...
            logout: function (data) {
                ...
                return new Promise(function (resolve) {
                    $__19.storage.removeItem($__19.tokenLocation);
                    cookieStorage.removeItem($__19.tokenLocation);
                    if ($__19.allowSocketIO) {
                        $__19.io.disconnect();
                        $__19.connectSocket();
                    }
                    resolve(data);

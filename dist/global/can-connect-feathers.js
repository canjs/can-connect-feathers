...
define('can-connect-feathers', [
    ...
    if (!$__10 || !$__10.__esModule)
        $__10 = { default: $__10 };
    var io = $__0.default;
    var cookie = $__2.default;
    var decode = $__4.default;
    var $__7 = $__6, stripSlashes = $__7.stripSlashes, addAliases = $__7.addAliases, isEmptyObject = $__7.isEmptyObject;
        ...
        return $traceurRuntime.createClass(Feathers, {
            connectSocket: function () {
                ...
                this.ioConnected = new Promise(function (resolve, reject) {
                    $__15.io = io($__15.url, $__15.socketOptions);
                    $__15.io.once('connect', resolve);
                    $__15.io.once('error', reject);
                });
            },
            ...
            authenticate: function (params) {
                ...
                return authPromise.then(function (data) {
                    return $__15.persistToken(data);
                }).then(function (data) {
                    return $__15.makeSSRCookie(data);
                });
            },
                ...
                return new Promise(function (resolve, reject) {
                    var sendSocketAuthRequest = function (data) {
                        ...
                        this.io.once('authenticated', function (res) {
                            if (!$__16._reconnectsHandled) {
                                $__16.handleSocketReconnects(data);
                                $__16._reconnectsHandled = true;
                            }
                            resolve(res);
                        });
                    ...
                    if ($__15.io.connected) {
                        sendSocketAuthRequest.call($__15, data);
                    } else {
                        $__15.io.once('connect', function () {
                            return sendSocketAuthRequest.call($__15, data);
                        });
                    }
                });
            },
            handleSocketReconnects: function (data) {
                ...
                this.io.on('reconnect', function () {
                    $__15.authenticateSocket(data).then(function (data) {
                        return $__15.persistToken(data);
                    }).then(function (data) {
                        return $__15.makeSSRCookie(data);
                    });
            ...
            logout: function (data) {
                ...
                return new Promise(function (resolve) {
                    $__15.storage.removeItem($__15.tokenLocation);
                    cookieStorage.removeItem($__15.tokenLocation);
                    if ($__15.allowSocketIO) {
                        $__15.io.disconnect();
                        $__15.connectSocket();
                    }
                    resolve(data);

...
/*can-connect-feathers@0.6.7#utils*/
...
/*can-connect-feathers@0.6.7#can-connect-feathers*/
    ...
    var Feathers = function () {
        function Feathers(config) {
            ...
            if (this.socketio !== false) {
                this.io = (0, _io['default'])(this.url, this.socketio || {});
            }
        }
        _createClass(Feathers, [
            ...
            },
            {
                ...
                value: function makeXhr(id, params, location) {
                    ...
                    if (type !== 'DELETE') {
                        _$['default'].extend(ajaxConfig, { data: params });
                    }

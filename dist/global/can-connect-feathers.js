...
/*can-connect-feathers@0.6.8#can-connect-feathers*/
        ...
        return $traceurRuntime.createClass(Feathers, {
            ...
            authenticate: function (params) {
                ...
                if (token) {
                    ...
                    if (this.io.connected) {
                        ...
                        this.io.once('connect', function () {
                            return authenticateSocket.call($__16, data);
                        });
                    }
                }
                ...
                return this.makeXhr(null, data, location, 'POST').then(function (data) {
                    return $__16.persistToken(data);
                }).then(function (data) {
                    return $__16.makeSSRCookie(data);
                });
            },
            ...
            logout: function (data) {
                ...
                return new Promise(function (resolve) {
                    $__16.storage.removeItem($__16.tokenLocation);
                    cookieStorage.removeItem($__16.tokenLocation);
                    resolve(data);
                });
            }
        }, {});

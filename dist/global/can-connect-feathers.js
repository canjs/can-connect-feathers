...
/*can-connect-feathers@0.6.9#utils*/
...
/*can-connect-feathers@0.6.9#can-connect-feathers*/
        ...
        return $traceurRuntime.createClass(Feathers, {
            ...
            authenticate: function (params) {
                ...
                if (token && this.allowSocketIO) {
                    var authenticateSocket = function (data) {
                    ...
                    if (this.io.connected) {
                        ...
                        this.io.once('connect', function () {
                            return authenticateSocket.call($__17, data);
                        });
                    }
                }

/*can-connect-feathers@0.1.3#can-connect-feathers*/
'use strict';
...
var Feathers = function () {
    function Feathers(config) {
        ...
        this.io = (0, _stealSocketIo2['default'])(this.url);
    }
    _createClass(Feathers, [
        ...
        },
        {
            ...
            value: function makeXhr(id, params, location) {
                ...
                return _jquery2['default'].ajax(ajaxConfig).fail(function (err) {
                    console.warn(err);
                    return err;
                });
            }
                    ...
                    (function () {
                        ...
                        if (_this.io.connected) {
                            ...
                            _this.io.once('connect', function () {
                                return authenticateSocket(data);
                            });
                        }
                    }());
                }

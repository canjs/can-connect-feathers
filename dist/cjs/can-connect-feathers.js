...
/*can-connect-feathers@1.2.1#can-connect-feathers*/
'use strict';
var $__steal_45_socket_46_io__, $__cookie_45_storage__, $__jwt_45_decode__, $__utils__, $__feathers_45_errors__, $__qs__;
...
var $__3 = ($__utils__ = require('./utils.js'), $__utils__ && $__utils__.__esModule && $__utils__ || { default: $__utils__ }), stripSlashes = $__3.stripSlashes, addAliases = $__3.addAliases, isEmptyObject = $__3.isEmptyObject;
    ...
    return $traceurRuntime.createClass(Feathers, {
        connectSocket: function () {
            ...
            this.ioConnected = new Promise(function (resolve, reject) {
                $__9.io = io($__9.url, $__9.socketOptions);
                $__9.io.once('connect', resolve);
                $__9.io.once('error', reject);
            });
        },
        ...
        authenticate: function (params) {
            ...
            return authPromise.then(function (data) {
                return $__9.persistToken(data);
            }).then(function (data) {
                return $__9.makeSSRCookie(data);
            });
        },
            ...
            return new Promise(function (resolve, reject) {
                var sendSocketAuthRequest = function (data) {
                    ...
                    this.io.once('authenticated', function (res) {
                        if (!$__10._reconnectsHandled) {
                            $__10.handleSocketReconnects(data);
                            $__10._reconnectsHandled = true;
                        }
                        resolve(res);
                    });
                ...
                if ($__9.io.connected) {
                    sendSocketAuthRequest.call($__9, data);
                } else {
                    $__9.io.once('connect', function () {
                        return sendSocketAuthRequest.call($__9, data);
                    });
                }
            });
        },
        handleSocketReconnects: function (data) {
            ...
            this.io.on('reconnect', function () {
                $__9.authenticateSocket(data).then(function (data) {
                    return $__9.persistToken(data);
                }).then(function (data) {
                    return $__9.makeSSRCookie(data);
                });
        ...
        logout: function (data) {
            ...
            return new Promise(function (resolve) {
                $__9.storage.removeItem($__9.tokenLocation);
                cookieStorage.removeItem($__9.tokenLocation);
                if ($__9.allowSocketIO) {
                    $__9.io.disconnect();
                    $__9.connectSocket();
                }
                resolve(data);

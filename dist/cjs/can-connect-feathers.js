...
/*can-connect-feathers@1.2.0#can-connect-feathers*/
'use strict';
var $__steal_45_socket_46_io__, $__jquery__, $__cookie_45_storage__, $__jwt_45_decode__, $__utils__, $__utils__, $__utils__, $__feathers_45_errors__, $__qs__;
var io = ($__steal_45_socket_46_io__ = require('steal-socket.io'), $__steal_45_socket_46_io__ && $__steal_45_socket_46_io__.__esModule && $__steal_45_socket_46_io__ || { default: $__steal_45_socket_46_io__ }).default;
var $ = ($__jquery__ = require('jquery'), $__jquery__ && $__jquery__.__esModule && $__jquery__ || { default: $__jquery__ }).default;
var cookie = ($__cookie_45_storage__ = require('cookie-storage'), $__cookie_45_storage__ && $__cookie_45_storage__.__esModule && $__cookie_45_storage__ || { default: $__cookie_45_storage__ }).default;
var decode = ($__jwt_45_decode__ = require('jwt-decode'), $__jwt_45_decode__ && $__jwt_45_decode__.__esModule && $__jwt_45_decode__ || { default: $__jwt_45_decode__ }).default;
var stripSlashes = ($__utils__ = require('./utils.js'), $__utils__ && $__utils__.__esModule && $__utils__ || { default: $__utils__ }).stripSlashes;
var addAliases = ($__utils__ = require('./utils.js'), $__utils__ && $__utils__.__esModule && $__utils__ || { default: $__utils__ }).addAliases;
var isEmptyObject = ($__utils__ = require('./utils.js'), $__utils__ && $__utils__.__esModule && $__utils__ || { default: $__utils__ }).isEmptyObject;
var errors = ($__feathers_45_errors__ = require('feathers-errors'), $__feathers_45_errors__ && $__feathers_45_errors__.__esModule && $__feathers_45_errors__ || { default: $__feathers_45_errors__ }).default;
var query = ($__qs__ = require('qs'), $__qs__ && $__qs__.__esModule && $__qs__ || { default: $__qs__ }).default;
var cookieStorage = new cookie.CookieStorage();
    ...
    return $traceurRuntime.createClass(Feathers, {
        connectSocket: function () {
            ...
            this.ioConnected = new Promise(function (resolve, reject) {
                $__12.io = io($__12.url, $__12.socketOptions);
                $__12.io.once('connect', resolve);
                $__12.io.once('error', reject);
            });
        },
            ...
            var service = {
                ...
                destroyData: function (data) {
                    return new Promise(function (resolve, reject) {
                        self.ioConnected.then(function () {
                            var executeAction = function () {
                                self.io.emit(location + '::remove', data[idProp], {}, function (error, data) {
                                    if (error) {
                                        return reject(error);
                                    }
                                    return resolve(data);
        ...
        getSession: function () {
            var session, token = this.getToken();
            if (token) {
        ...
        authenticate: function (params) {
            ...
            return authPromise.then(function (data) {
                return $__12.persistToken(data);
            }).then(function (data) {
                return $__12.makeSSRCookie(data);
            });
        },
            ...
            return new Promise(function (resolve, reject) {
                var sendSocketAuthRequest = function (data) {
                    ...
                    this.io.once('authenticated', function (res) {
                        if (!$__13._reconnectsHandled) {
                            $__13.handleSocketReconnects(data);
                            $__13._reconnectsHandled = true;
                        }
                        resolve(res);
                    });
                ...
                if ($__12.io.connected) {
                    sendSocketAuthRequest.call($__12, data);
                } else {
                    $__12.io.once('connect', function () {
                        return sendSocketAuthRequest.call($__12, data);
                    });
                }
            });
        },
        handleSocketReconnects: function (data) {
            ...
            this.io.on('reconnect', function () {
                $__12.authenticateSocket(data).then(function (data) {
                    return $__12.persistToken(data);
                }).then(function (data) {
                    return $__12.makeSSRCookie(data);
                });
        ...
        logout: function (data) {
            ...
            return new Promise(function (resolve) {
                $__12.storage.removeItem($__12.tokenLocation);
                cookieStorage.removeItem($__12.tokenLocation);
                if ($__12.allowSocketIO) {
                    $__12.io.disconnect();
                    $__12.connectSocket();
                }
                resolve(data);

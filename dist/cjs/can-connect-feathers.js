...
/*can-connect-feathers@1.1.1#can-connect-feathers*/
'use strict';
var $__steal_45_socket_46_io__, $__jquery__, $__cookie_45_storage__, $__jwt_45_decode__, $__utils__, $__utils__, $__feathers_45_errors__;
    ...
    return $traceurRuntime.createClass(Feathers, {
        connectSocket: function () {
            ...
            this.ioConnected = new Promise(function (resolve, reject) {
                $__10.io = io($__10.url, $__10.socketOptions);
                $__10.io.once('connect', resolve);
                $__10.io.once('error', reject);
            });
        },
        ...
        authenticate: function (params) {
            ...
            return authPromise.then(function (data) {
                return $__10.persistToken(data);
            }).then(function (data) {
                return $__10.makeSSRCookie(data);
            });
        },
            ...
            return new Promise(function (resolve, reject) {
                var sendSocketAuthRequest = function (data) {
                    ...
                    this.io.once('authenticated', function (res) {
                        if (!$__11._reconnectsHandled) {
                            $__11.handleSocketReconnects(data);
                            $__11._reconnectsHandled = true;
                        }
                        resolve(res);
                    });
                ...
                if ($__10.io.connected) {
                    sendSocketAuthRequest.call($__10, data);
                } else {
                    $__10.io.once('connect', function () {
                        return sendSocketAuthRequest.call($__10, data);
                    });
                }
            });
        },
        handleSocketReconnects: function (data) {
            ...
            this.io.on('reconnect', function () {
                $__10.authenticateSocket(data).then(function (data) {
                    return $__10.persistToken(data);
                }).then(function (data) {
                    return $__10.makeSSRCookie(data);
                });
        ...
        logout: function (data) {
            ...
            return new Promise(function (resolve) {
                $__10.storage.removeItem($__10.tokenLocation);
                cookieStorage.removeItem($__10.tokenLocation);
                if ($__10.allowSocketIO) {
                    $__10.io.disconnect();
                    $__10.connectSocket();
                }
                resolve(data);

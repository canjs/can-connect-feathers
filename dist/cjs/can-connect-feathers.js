...
/*can-connect-feathers@1.1.4#can-connect-feathers*/
'use strict';
var $__steal_45_socket_46_io__, $__jquery__, $__cookie_45_storage__, $__jwt_45_decode__, $__utils__, $__utils__, $__utils__, $__feathers_45_errors__;
    ...
    return $traceurRuntime.createClass(Feathers, {
        connectSocket: function () {
            ...
            this.ioConnected = new Promise(function (resolve, reject) {
                $__11.io = io($__11.url, $__11.socketOptions);
                $__11.io.once('connect', resolve);
                $__11.io.once('error', reject);
            });
        },
        ...
        authenticate: function (params) {
            ...
            return authPromise.then(function (data) {
                return $__11.persistToken(data);
            }).then(function (data) {
                return $__11.makeSSRCookie(data);
            });
        },
            ...
            return new Promise(function (resolve, reject) {
                var sendSocketAuthRequest = function (data) {
                    ...
                    this.io.once('authenticated', function (res) {
                        if (!$__12._reconnectsHandled) {
                            $__12.handleSocketReconnects(data);
                            $__12._reconnectsHandled = true;
                        }
                        resolve(res);
                    });
                ...
                if ($__11.io.connected) {
                    sendSocketAuthRequest.call($__11, data);
                } else {
                    $__11.io.once('connect', function () {
                        return sendSocketAuthRequest.call($__11, data);
                    });
                }
            });
        },
        handleSocketReconnects: function (data) {
            ...
            this.io.on('reconnect', function () {
                $__11.authenticateSocket(data).then(function (data) {
                    return $__11.persistToken(data);
                }).then(function (data) {
                    return $__11.makeSSRCookie(data);
                });
        ...
        logout: function (data) {
            ...
            return new Promise(function (resolve) {
                $__11.storage.removeItem($__11.tokenLocation);
                cookieStorage.removeItem($__11.tokenLocation);
                if ($__11.allowSocketIO) {
                    $__11.io.disconnect();
                    $__11.connectSocket();
                }
                resolve(data);
